...
def train_test_val_split_and_save(s3_client, bucket_name, input_key, output_dir, test_size=0.3, val_size=0.3, random_state=42):
    """
    ...
    train_data, test_val_data = train_test_split(data, test_size=(test_size + val_size), random_state=random_state)
    ...
    test_data, val_data = train_test_split(test_val_data, test_size=test_ratio, random_state=random_state)
